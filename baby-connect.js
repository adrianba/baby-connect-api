...
Connect.prototype.login = function() {
  return new Promise((resolve, reject) => {
    doPost(
      "https://www.baby-connect.com/Cmd?cmd=UserAuth",
      this.nextCookie,
      {
        email: this.username,
        pass: this.password
      ...
      (error, result) => {
        if (error) {
          ...
          if (result.statusCode === 200) {
            ...
            /*&& result.location=='https://www.baby-connect.com/home'*/ if (result.nextCookie) {
...
Connect.prototype.getUserInfo = function() {
  ...
  return new Promise((resolve, reject) => {
    doPost(
      "https://www.baby-connect.com/CmdW?cmd=UserInfoW",
      this.nextCookie,
      formData,
      (error, result) => {
        if (error) {
...
Connect.prototype.getStatus = function(p) {
  ...
  return new Promise((resolve, reject) => {
    doPost(
      "https://www.baby-connect.com/CmdListW?cmd=StatusList",
      this.nextCookie,
      formData,
      (error, result) => {
        if (error) {
